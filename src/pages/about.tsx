    ...
    <>
      ...
      <Layout>
        <main className="flex flex-col items-center justify-center min-h-screen bg-background text-foreground p-6">
          ...
          {/* Introduction */}
          <p className="mt-6 text-lg max-w-2xl text-center leading-relaxed text-foreground">
            Hello! I'm Bharath, a passionate <span className="font-semibold text-accent-color">Data Engineer</span> and 
            <span className="font-semibold text-accent-color"> Data Science Enthusiast</span>. I love diving into complex datasets 
          ...
          <p className="mt-4 max-w-2xl text-center text-foreground">
            I've had the pleasure of working at <span className="font-semibold text-accent-color">Mayo Clinic</span>, 
            <span className="font-semibold text-accent-color"> HSBC</span>, and <span className="font-semibold text-accent-color">SpringML</span>, 
          ...
          <ul className="mt-4 list-disc list-inside text-foreground space-y-2 max-w-lg">
